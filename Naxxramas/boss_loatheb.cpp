...
public:
    ...
    struct boss_loathebAI : public BossAI
    {
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_SUMMON_SPORE_GIANT, 30000);
            if (pInstance)
            {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_NECROTIC_AURA_REMOVED:
                    ...
                    if (healingCycle == 4)
                    {
                        events.ScheduleEvent(EVENT_SUMMON_SPORE_GIANT, 1000);
                    }
                    break;
                case EVENT_SUMMON_SPORE_GIANT:
                    me->SummonCreature(NPC_SPORE_GIANT, me->GetPositionX() + urand(5, 15), me->GetPositionY() + urand(5, 15), me->GetMapHeight(me->GetPositionX(), me->GetPositionY(), me->GetPositionZ()));
                    healingCycle = 0;
                    break;
            }
