    ...
    struct boss_heiganAI : public BossAI
    {
        ...
        void StartFightPhase(uint8 phase)
        {
            ...
            if (phase == PHASE_SLOW_DANCE)
            {
                ...
                events.ScheduleEvent(EVENT_VOLATILE_INFECTION, 15000);
            }
            else // if (phase == PHASE_FAST_DANCE)
            {
                ...
                events.ScheduleEvent(EVENT_SWITCH_PHASE, 46000);
                events.ScheduleEvent(EVENT_VOLATILE_INFECTION, 15000);
            }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_VOLATILE_INFECTION:
                for (uint8 i = 0; i < RAID_MODE(3, 7); ++i)
                {
                    ...
                    {
                        me->CastSpell(target, SPELL_VOLATILE_INFECTION);
                    }
                }
            ...
            case EVENT_PLAGUE_CLOUD:
                me->AddAura(SPELL_PLAGUE_CLOUD, me);
